  ...
  return (
    <section className="bg-[#F5F5F5] pt-16 sm:pt-20 lg:pt-28 pb-16 sm:pb-20 lg:pb-28">
      <div className="max-w-[1440px] mx-auto">
        ...
        {/* Heading */}
        <h2
          className="font-medium leading-[1.08] tracking-[-0.03em] mb-10 sm:mb-14 lg:mb-16 px-5 sm:px-8 lg:px-12 text-gray-900"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 lg:gap-7 px-5 sm:px-8 lg:px-12">
          ...
          <div>
            <div className="relative aspect-[329/246] rounded-2xl overflow-hidden bg-[#1a1d2e] group cursor-pointer">
              ...
              />
              {/* Hover button */}
              <div className="absolute bottom-4 left-4 h-9 rounded-full bg-white flex items-center gap-2 overflow-hidden transition-all duration-300 ease-in-out w-9 group-hover:w-[148px]">
                <span className="text-[13px] font-medium opacity-0 group-hover:opacity-100 transition-opacity delay-100 whitespace-nowrap pl-4">
                  Learn more
                </span>
                <span className="shrink-0 flex items-center justify-center w-7 h-7 mr-1">
                  <LinkIcon />
                </span>
              </div>
            </div>
          ...
          <div>
            <div className="relative aspect-square rounded-2xl overflow-hidden bg-[#6b6b6b] group cursor-pointer">
              ...
              />
              {/* Hover button */}
              <div className="absolute bottom-4 left-4 h-9 rounded-full bg-gray-900 flex items-center gap-2 overflow-hidden transition-all duration-300 ease-in-out w-9 group-hover:w-[168px]">
                <span className="text-[13px] font-medium text-white opacity-0 group-hover:opacity-100 transition-opacity delay-100 whitespace-nowrap pl-4">
                  View case study
                </span>
                <ArrowRight size={14} className="text-white -rotate-45 group-hover:rotate-0 transition-transform duration-300 flex-shrink-0 mr-2" />
              </div>
            </div>
            <p className="text-[13px] sm:text-[14px] text-gray-600 mt-4 leading-relaxed">
